...
Our tutorial in _Clinical Pharmacology & Therapeutics: Pharmacometrics & Systems Pharmacology_ [@Fidler2019] was one of that journal’s top ten most-read articles in 2021, with over 4,000 downloads. Our article had been one of the top 10%
most-downloaded papers in 2018-2019, and having such interest for the second time in a row is tremendously encouraging for all of us! We hope it’s a reflection of the enthusiasm the community is building for our tool, and hope that it will continue.
...
Finally: Concern! What will happen to NONMEM when its sole lead developer retires? Having a backup solution is
very reassuring.
