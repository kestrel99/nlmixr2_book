...
```{r}
#| label: fig-lmedat
#| fig-cap: "Individual plots of average reaction time against days of sleep deprivation."
#| warning: false
#| message: false
#| echo: false
#| height: 18
...
```{r}
#| label: fig-reserr
#| fig-cap: "Residual error: differences between observations and model predictions."
#| warning: false
#| message: false
#| echo: false
#| height: 12
...
```{r}
#| label: fig-reserr2
#| fig-cap: "Residual error is assumed to be normally distributed."
#| warning: false
#| message: false
#| echo: false
#| height: 7
